namespace :"render-dashboard" do
  ...
  desc "Show Render service and disk info for all services (or set service_id / RENDER_DISK_SERVICE_ID for one)"
  task info: :environment do
    client = RenderDashboard::Client.new

    service_id = ENV["service_id"] || ENV["RENDER_DISK_SERVICE_ID"]
